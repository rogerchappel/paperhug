...
Replace this section with the supported versions for `paperhug`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `paperhug` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ../paperhug.
