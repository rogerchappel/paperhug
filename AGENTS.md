# Agent Operating Instructions for paperhug

This file defines how AI agents and human maintainers should work in `paperhug`.

## Project Context

- Project: `paperhug`
- Repository: `https://github.com/rogerchappel/paperhug` (`rogerchappel/paperhug`)
- Primary maintainer: `Roger Chappel`
- Default branch: `main`
- Package manager: `npm` with workspaces in `apps/*` and `packages/*`
